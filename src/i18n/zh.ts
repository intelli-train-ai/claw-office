...
const zh: Record<TranslationKey, string> = {
  ...
  'chatList.deleteConversationConfirm': '该对话将被永久删除，此操作无法撤销。',
  'chatList.copySessionId': '复制对话 ID',
  'chatList.renameConversation': '重命名对话',
  'chatList.removeProject': '移出项目',
  'chatList.removeProjectConfirm': '确定移除项目「{project}」及其所有对话？此操作无法撤销。',
  'chatList.openFolder': '打开文件夹',
  'chatList.copyFolderPath': '复制文件夹路径',
  'chatList.downloadZip': '下载为 ZIP',
  'chatList.downloadZipPreparing': '正在打包项目…',
  'chatList.downloadZipSuccess': '项目 ZIP 已下载',
  'chatList.downloadZipFailed': '下载 ZIP 失败：{error}',
  ...
  // ── Message list ────────────────────────────────────────────
  'messageList.claudeChat': 'SafeClaw 对话',
  'messageList.emptyDescription': '开始与 SafeClaw 对话。提问、获取代码帮助或探索想法。',
  ...
  // ── Settings: General ───────────────────────────────────────
  'settings.title': '设置',
  'settings.description': '管理 SafeClaw 和 Claude CLI 设置',
  'settings.general': '通用',
  'settings.providers': '服务商',
  'settings.claudeCli': 'Claude CLI',
  'settings.safeclaw': 'SafeClaw',
  ...
  'settings.errorReportingDesc': '帮助改进 SafeClaw：匿名上报错误信息，不包含对话内容和 API Key。更改后需重启应用才能完全生效。',
  ...
  'settings.appearanceDesc': '自定义 SafeClaw 的外观和风格',
  ...
  'provider.ccSwitchHint': '通过类似 cc switch 等工具添加的 Claude Code 配置可能无法被 SafeClaw 读取，建议在此处重新添加。',
  ...
  'connection.gitInstallSuccess': 'Git 安装成功！请重启 SafeClaw。',
  ...
  'connection.upgradeSuccess': '升级成功！请重启 SafeClaw 以应用更新。',
  ...
  'update.readyToInstall': 'SafeClaw v{version} 已就绪 — 重启以完成更新',
  'update.installUpdate': '下载并安装',
  'update.later': '稍后',
  'update.rosettaWarning': 'SafeClaw 当前正通过 Rosetta 在这台 Apple Silicon Mac 上运行。安装 arm64 版本可获得更好的响应速度。',
  ...
  'bridge.assistantConnected': '助理 {name} 已接入',
  'bridge.assistantDefault': '助理',
  'bridge.assistantConnectedHint': '桥接会话将自动获得助理的记忆和身份',
  'bridge.assistantNotConfigured': '助理未配置',
  'bridge.assistantNotConfiguredHint': '前往设置完成助理配置后，桥接会话将自动接入助理',
  'bridge.systemPrompt': '桥接专属指令',
  'bridge.systemPromptPlaceholder': '例如：回复使用纯文本，不要用 Markdown 格式。保持简洁，每条消息不超过 300 字。提及文件时使用绝对路径。',
  'bridge.systemPromptHint': '仅对桥接会话生效的指令。留空则使用内置默认指令（纯文本格式、简洁回复、绝对路径等）',
  'bridge.defaultWorkDir': '工作目录',
  'bridge.defaultWorkDirHint': '桥接会话的默认项目文件夹',
  'bridge.defaultModel': '模型',
  'bridge.defaultModelHint': '桥接会话的默认模型',
  'bridge.defaultMode': '默认模式',
  'bridge.defaultModeCode': '执行',
  'bridge.defaultModePlan': '计划',
  'bridge.defaultModeHint': '桥接会话的默认模式',
  'bridge.defaultPermission': '默认权限',
  'bridge.defaultPermissionDefault': '默认权限',
  'bridge.defaultPermissionFullAccess': '完全访问',
  'bridge.defaultPermissionWarning': '完全访问将自动批准所有权限请求，包括文件写入和命令执行',
  'bridge.browse': '浏览',
  'bridge.start': '启动桥接',
  'bridge.stop': '停止桥接',
  'bridge.starting': '启动中...',
  ...
  'mcp.enabled': '已启用',
  'mcp.disabled': '已禁用',
  'mcp.managerDesc': '开关控制 SafeClaw 注入的 MCP 服务。Claude Code 自身配置中的服务仍可能被 SDK 通过 settingSources 自动加载。',
  ...
  'cliTools.viewDocs': '查看 SafeClaw 官方文档',
  ...
  'setup.welcome.description': 'SafeClaw 是多模型 AI Agent 桌面客户端。连接任意 AI 服务商，通过 MCP 和 Skills 扩展能力，让你的助理学会你的工作方式。',

  // Setup: Claude Code card
  'setup.claude.title': 'Claude Code CLI',
  'setup.claude.description': 'SafeClaw 需要 Claude Code CLI 才能正常工作。',
  ...
  'setup.provider.description': '配置 SafeClaw 连接 AI 模型的方式。',
  ...
  'chat.assistantToggle.label': '助理',
  'chat.assistantToggle.enabled': '助理已启用 — AI 可访问助理记忆和身份',
  'chat.assistantToggle.disabled': '助理已关闭 — 纯项目对话模式',
  'chat.projectDir.label': '工作目录',
  'chat.projectDir.attach': '附加项目目录 — AI 可在该目录下工作',
  'chat.projectDir.detach': '移除项目目录',
  ...
  'share.generatedBy': '由 SafeClaw 生成',
  ...
  'settings.security.accessTokenDesc': '设置访问令牌后，需要输入令牌才能使用 SafeClaw。适用于公网部署场景。',
  'settings.security.tokenConfigured': '令牌已配置',
  'settings.security.tokenNotConfigured': '未配置令牌（开放访问）',
  'settings.security.tokenFromEnv': '令牌通过 SAFECLAW_ACCESS_TOKEN 环境变量设置',
