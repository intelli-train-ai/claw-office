...
const en = {
  ...
  'chatList.downloadZip': 'Download as ZIP',
  'chatList.downloadZipPreparing': 'Packaging project...',
  'chatList.downloadZipSuccess': 'Project ZIP downloaded',
  'chatList.downloadZipFailed': 'Failed to download ZIP: {error}',
  ...
  'bridge.assistantConnected': 'Assistant {name} connected',
  'bridge.assistantDefault': 'Assistant',
  'bridge.assistantConnectedHint': 'Bridge sessions will automatically have access to assistant memory and identity',
  'bridge.assistantNotConfigured': 'Assistant not configured',
  'bridge.assistantNotConfiguredHint': 'Configure assistant in settings to auto-connect it with bridge sessions',
  'bridge.systemPrompt': 'Bridge Instructions',
  'bridge.systemPromptPlaceholder': 'e.g.: Reply in plain text, no Markdown. Keep responses concise, under 300 chars. Use absolute paths when referencing files.',
  'bridge.systemPromptHint': 'Applied only to bridge sessions. Leave empty to use built-in defaults (plain text, concise, absolute paths, etc.)',
  ...
  'bridge.defaultMode': 'Default Mode',
  'bridge.defaultModeCode': 'Code',
  'bridge.defaultModePlan': 'Plan',
  'bridge.defaultModeHint': 'Default mode for bridge sessions',
  'bridge.defaultPermission': 'Default Permission',
  'bridge.defaultPermissionDefault': 'Default',
  'bridge.defaultPermissionFullAccess': 'Full Access',
  'bridge.defaultPermissionWarning': 'Full Access auto-approves all permission requests including file writes and shell commands',
  ...
  'chat.assistantToggle.label': 'Assistant',
  'chat.assistantToggle.enabled': 'Assistant enabled — AI has access to assistant memory and identity',
  'chat.assistantToggle.disabled': 'Assistant disabled — pure project chat mode',
  'chat.projectDir.label': 'Project',
  'chat.projectDir.attach': 'Attach a project directory — AI can work in that directory',
  'chat.projectDir.detach': 'Remove project directory',
  ...
  'settings.security.tokenFromEnv': 'Token is set via SAFECLAW_ACCESS_TOKEN environment variable',
