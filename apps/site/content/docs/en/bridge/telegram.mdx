...
4. Once verified, click **Auto-detect Chat ID**:
   ...
   - Then click the detect button; SafeClaw will automatically retrieve your Chat ID
...
1. Confirm the SafeClaw bridge service is running (Bridge page shows "Connected")
