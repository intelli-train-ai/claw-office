...
The Discord WebSocket connection may drop due to network fluctuations. SafeClaw will automatically reconnect. If it keeps disconnecting, check your network connection.
