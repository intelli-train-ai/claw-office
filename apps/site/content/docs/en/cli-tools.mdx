...
Many AI workflows require command-line tools — FFmpeg for video processing, jq for JSON parsing, ripgrep for code search. SafeClaw's CLI Tools feature helps you manage these tools and lets Claude automatically know what's available on your machine.
...
After installing tools, you don't need to do anything extra. SafeClaw automatically detects your installed tools before each conversation and includes them in the system prompt.
