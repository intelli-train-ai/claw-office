...
SafeClaw is more than a chat window. You can open a file tree, check your Git status, commit code, and even launch a terminal — all without switching to another app.
...
| **Stage** | Select which files to include in the next commit. SafeClaw currently stages all changes automatically. |
