---
title: Chat
description: SafeClaw's chat features — modes, permissions, and context management.
---

# Chat

Chat is SafeClaw's core feature. This is where you collaborate with Claude on programming tasks.

## Conversation Modes

SafeClaw offers three conversation modes, switchable at any time from above the input box:
...
SafeClaw supports rewinding a conversation to a previous point. Each user message is a rewind point — you can go back to any earlier message and restart the conversation from there.
...
If you have previously used the Claude Code CLI, you can use the **Import Session** feature to bring CLI conversations into SafeClaw. Supports searching and filtering past sessions.
