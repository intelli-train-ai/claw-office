---
title: 快速开始
description: 开始使用 SafeClaw — Claude Code 的桌面工作区。
---

# 快速开始

SafeClaw 是 Claude Code 的桌面工作区，把对话、服务商、MCP、技能、桥接和助理工作区整合到一个界面中。

## 准备工作

使用 SafeClaw 之前，你需要：

1. **Node.js 18+** — SafeClaw 依赖 Node.js 运行 Claude Code CLI
...
1. 从 [GitHub Releases](https://github.com/intelli-train-ai/claw-office/releases) 下载适合你平台的安装包（[详细安装指南](/zh/docs/installation)）
2. 安装并启动 SafeClaw
