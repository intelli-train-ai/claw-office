...
2. 認証: `claude login`
3. [Releases](https://github.com/intelli-train-ai/CodePilot/releases) ページからプラットフォームに合ったインストーラーをダウンロード
4. SafeClaw を起動
...
[Releases](https://github.com/intelli-train-ai/CodePilot/releases) ページからダウンロードしてください。
...
- [GitHub Issues](https://github.com/intelli-train-ai/CodePilot/issues) -- バグ報告と機能リクエスト
- [GitHub Discussions](https://github.com/intelli-train-ai/CodePilot/discussions) -- 質問と一般的なディスカッション
